...
<#-- Style defined in Moqui using database entries -->
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<#-- To be replaced by the contact info in web root screen -->
								<li><a href="#"><i class="fa fa-phone"></i> +2 95 01 88 821</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> info@domain.com</a></li>
							</ul>
						</div>
					</div>
					<#-- Disable social media support for now 
					<div class="col-sm-6">
	...
	<div id="${sri.screenUrlInfo.targetScreen.getDefaultMenuName()}" class="container">
