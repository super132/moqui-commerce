	...
	<footer id="footer"><!--Footer-->
		<#-- Disable footer top for now, TODO: re-enable it by re-usable component 
		<div class="footer-top">
			<div class="container">
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<#-- TODO: use dynamic data to replace this section -- >
		...
		<div class="footer-widget">
			<div class="container">
			<#-- TODO: Populate the links below from screen definition / settings -->
				<div class="row">
					<div class="col-sm-2">
